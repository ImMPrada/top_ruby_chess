...
RSpec.describe Chess::Core::Pieces::King do
  subject(:king) { described_class.create_and_occupy(Chess::Core::Constants::WHITE_TEAM, cell_e1) }
  ...
  describe '#castle_with' do
    describe 'queenside' do
      let(:rook) { Chess::Core::Pieces::Rook.create_and_occupy(Chess::Core::Constants::WHITE_TEAM, cell_a1) }
      ...
      it 'returns nil if there is a piece between king and rook' do
        Chess::Core::Pieces::Rook.create_and_occupy(Chess::Core::Constants::WHITE_TEAM, cell_c1)
    ...
    describe 'kingside' do
      let(:rook) { Chess::Core::Pieces::Rook.create_and_occupy(Chess::Core::Constants::WHITE_TEAM, cell_h1) }
      let(:cell_f1) { cells[0][5] }
      let(:cell_h1) { cells[0][7] }
      ...
      it 'returns nil if there is a piece between king and rook' do
        Chess::Core::Pieces::Rook.create_and_occupy(Chess::Core::Constants::WHITE_TEAM, cell_g1)
