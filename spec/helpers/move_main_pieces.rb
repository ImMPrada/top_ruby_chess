...
module Helpers
  module MoveMainPieces
    ...
    def white_pieces(case_of_use, board)
      ...
      when :case2
        ...
        board.pieces.white.instance_variable_set(
          :@rooks,
          [
            Chess::Core::Pieces::Rook.create_and_occupy(Chess::Constants::WHITE_TEAM, board.cells.dig(1, 4))
          ]
        )
      when :case3
        basic_white_king(board)
        ...
        board.pieces.white.instance_variable_set(
          :@rooks,
          [
            Chess::Core::Pieces::Rook.create_and_occupy(Chess::Constants::WHITE_TEAM, board.cells.dig(2, 4))
          ]
        )
        board.pieces.black.instance_variable_set(
          :@rooks,
          [
            Chess::Core::Pieces::Rook.create_and_occupy(Chess::Constants::BLACK_TEAM, board.cells.dig(2, 7))
          ]
        )
      when :case4
        basic_white_king(board)
        ...
        board.pieces.white.instance_variable_set(
          :@rooks,
          [
            Chess::Core::Pieces::Rook.create_and_occupy(Chess::Constants::BLACK_TEAM, board.cells.dig(0, 0)),
            Chess::Core::Pieces::Rook.create_and_occupy(Chess::Constants::BLACK_TEAM, board.cells.dig(0, 7))
          ]
        )
      when :case5
        basic_white_king(board)
        ...
        board.pieces.black.instance_variable_set(
          :@rooks,
          [
            Chess::Core::Pieces::Rook.create_and_occupy(Chess::Constants::BLACK_TEAM, board.cells.dig(7, 2)),
            Chess::Core::Pieces::Rook.create_and_occupy(Chess::Constants::BLACK_TEAM, board.cells.dig(7, 6))
          ]
        )
      end
    end
    ...
    def basic_white_king(board)
      board.pieces.white.instance_variable_set(
        :@king,
        Chess::Core::Pieces::King.create_and_occupy(Chess::Constants::WHITE_TEAM, board.cells.dig(0, 4))
      )
    end
