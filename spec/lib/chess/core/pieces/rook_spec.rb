...
RSpec.describe Chess::Core::Pieces::Rook do
  subject(:rook) { described_class.create_and_occupy(Chess::Core::Constants::WHITE_TEAM, cell_a1) }
  ...
  describe 'whit other pieces occupyng cells, and starting at a1' do
    ...
    before do
      described_class.create_and_occupy(Chess::Core::Constants::BLACK_TEAM, cell_a8)
      described_class.create_and_occupy(Chess::Core::Constants::WHITE_TEAM, cell_d1)
    end
  ...
  describe '#can_castle?' do
    describe 'queenside rook' do
      ...
      describe 'when path is not free' do
        before do
          described_class.create_and_occupy(Chess::Core::Constants::WHITE_TEAM, cells[0][2])
        end
    ...
    describe 'kingside rook' do
      subject(:rook_kingside) { described_class.create_and_occupy(Chess::Core::Constants::WHITE_TEAM, cell_h8) }
      ...
      describe 'when path is not free' do
        before do
          described_class.create_and_occupy(Chess::Core::Constants::WHITE_TEAM, cells[7][5])
        end
    ...
    describe '#castle' do
      ...
      describe 'queenside' do
        let(:rook) { described_class.create_and_occupy(Chess::Core::Constants::WHITE_TEAM, cell_a1) }
        let(:cell_a1) { cells[0][0] }
      ...
      describe 'kingside' do
        let(:rook) { described_class.create_and_occupy(Chess::Core::Constants::WHITE_TEAM, cell_h8) }
        let(:cell_h8) { cells[7][7] }
